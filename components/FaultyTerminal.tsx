  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      if (!pause) {
        ...
        if (program.uniforms.iTime) program.uniforms.iTime.value = elapsed;
        frozenTimeRef.current = elapsed;
      } else {
        if (program.uniforms.iTime) program.uniforms.iTime.value = frozenTimeRef.current;
      }
      ...
      if (pageLoadAnimation && loadAnimationStartRef.current > 0) {
        ...
        if (program.uniforms.uPageLoadProgress) program.uniforms.uPageLoadProgress.value = progress;
      }
